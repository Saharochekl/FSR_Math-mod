...
public:
   ...
   cTle getCTle() const {return this->m_tle;}

   void updateIncl(double incl)
   {
       this->m_Inclination = incl;
   }

   void updateRAAN(double RAAN)
   {
       this->m_RAAN = RAAN;
   }
   ...
   void updateMeanMotion(double mm)
   {
       this->m_TleMeanMotion = mm;
   }

   void updateArgPerigee(double ArgPerigee)
   {
       this->m_ArgPerigee = ArgPerigee;
   }

   void updateMeanAnomaly(double MeanAnomaly)
   {
       this->m_MeanAnomaly = MeanAnomaly;
   }
